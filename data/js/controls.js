...
function start() {
    ...
    websock = new WebSocket(socket_url + "/ws");
		...
		/*if ($("#option" + data.id).length)
		 ...
		 if (data.parentControl) {
		    ...
		    option.remove();
		              ...
		              */
                    //$("#option" + data.id).attr("hidden", true);
                //}
                //else {
                  //console.log("showing option");
                  //$("#option" + data.id).removeAttr("hidden");
                //}
                //$("#option" + data.id).val(data.value);
                //$("#option" + data.id).text(data.label);
                /*if (data.hasOwnProperty('visible')) {
		console.log("has visible");
                
                  if (data['visible'])
                    $("#option" + data.id).removeAttr("hidden");
                  else $("#option" + data.id).attr("hidden", true);
                }*/
                break;
