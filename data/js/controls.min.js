...
break;case UPDATE_DETAILS:$("#dl"+data.id).html(data.value);if(data.hasOwnProperty('elementStyle')){$("#details"+data.id).attr("style",data.elementStyle);}
...
"' ><div class='ball"+id+"'></div><pre class='accelerometeroutput"+id+"'></pre>";case UI_DETAILS:return"<details id='details"+id+"' "+elementStyle+">"+
"<summary class='details-summary'>"+data.label+"</summary>"+
"<span id='dl"+id+"' class='label label-wrap details-content'>"+data.value+"</span>"+
"</details>";default:return"";}}
